...
class StockPriceUpdater:
    ...
    def process_single_stock(self, stock: Dict) -> Optional[Dict]:
        ...
        is_us_stock = not any(stock_name.endswith(suffix)
                              for suffix in (TPE_SUFFIX, TWO_SUFFIX))
    ...
    def _process_all_stocks(self, stock_list: List[Dict],
                            ignore_market_hours: bool) -> List[Dict]:
        """處理所有股票數據"""
        all_stock_data = []
